...
class EOS extends _scatterCore.Plugin {

    constructor() {
        super(_scatterCore.Blockchains.EOS, _scatterCore.PluginTypes.BLOCKCHAIN_SUPPORT);
    }
    ...
    signatureProvider(...args) {
        ...
        return (network, _eos, _options = {}) => {
            ...
            network = _scatterCore.Network.fromJson(network);
                    ...
                    return (...args) => {
                        ...
                        const signProvider = (() => {
                            var _ref = (0, _asyncToGenerator3.default)(function* (signargs) {
                                ...
                                const payload = (0, _assign2.default)(signargs, { blockchain: _scatterCore.Blockchains.EOS, network, requiredFields: requiredFields.requiredFields });
