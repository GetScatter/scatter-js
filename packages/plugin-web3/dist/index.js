...
class ETH extends _scatterjsCore.Plugin {

    constructor() {
        super(_scatterjsCore.Blockchains.ETH, _scatterjsCore.PluginTypes.BLOCKCHAIN_SUPPORT);
    }

    signatureProvider(...args) {

        return (_network, _web3) => {
            ethNetwork = _scatterjsCore.Network.fromJson(_network);
...
class ScatterEthereumWallet {
    ...
    getAccounts(callback) {
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            const accounts = !result ? [] : result.accounts.filter(function (account) {
                return account.blockchain === _scatterjsCore.Blockchains.ETH;
    ...
    signTransaction(transaction) {
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            const payload = (0, _assign2.default)(transaction, { blockchain: _scatterjsCore.Blockchains.ETH, network: ethNetwork, requiredFields });
            const { signatures, returnedFields } = yield _scatterjsCore.SocketService.sendApiRequest({
